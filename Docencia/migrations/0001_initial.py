    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/comment', verbose_name='Foto Perfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateend', models.DateField(default=datetime.date(2021, 2, 27), verbose_name='Fecha de Fin')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, unique=True, verbose_name='Nombre')),
                ('background', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/index/bg', verbose_name='Background Image')),
                ('icon', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/index/icon', verbose_name='Icon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/news', verbose_name='Imagen Principal')),
                ('date', models.DateTimeField(verbose_name='Fecha de Publicación')),
                ('image_1', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/news', verbose_name='Imagen Galería 1')),
                ('image_2', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/news', verbose_name='Imagen Galería 2')),
                ('image_3', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/news', verbose_name='Imagen Galería 3')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/image/blog')),
                ('date', models.DateTimeField(verbose_name='Fecha de Publicación')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='static/event/image')),
