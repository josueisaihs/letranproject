...
def admindashboard_detail(req, coursepk):
    ...
    try:
        ...
        for app in apps_obj:
            answers = AnswerApplication.objects.filter(student=app.student).order_by('askApp__order')
            app.answers = answers
            apps.append(app)
...
def admindashboard_student_detail(req, apppk):
    ...
    try:
        ...
        answers = AnswerApplication.objects.filter(student=app_obj.student).order_by('askApp__order')
